...
it('can recommend a property name when there is a similar property', function () {
    ...
    expect($solution->getSolutionDescription())->toEqual('Did you mean QuantaQuirk\Ignition\Tests\TestClasses\Models\Car::$color ?');
});
...
{
    return new ErrorException("Undefined property: QuantaQuirk\Ignition\Tests\TestClasses\Models\Car::$$property ");
}
