...
it('can recommend a property name when there is a similar property', function () {
    ...
    expect($solution->getSolutionDescription())->toEqual('Did you mean QuantaForge\Ignition\Tests\TestClasses\Models\Car::$color ?');
});
...
{
    return new ErrorException("Undefined property: QuantaForge\Ignition\Tests\TestClasses\Models\Car::$$property ");
}
